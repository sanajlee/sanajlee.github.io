...
### Ongoing
* Cross-lingual language modeling based on typological consideration
* Feature generalization using probabilistic methods
* Natural Language Inference focused on some specific linguistic phenomena
...
* Sangah Lee and Hyopil Shin (2016), <span style="color:#9AC6CD">[Stance Classification of Online Debate Texts based on Discourse Relations](https://www.dbpia.co.kr/Journal/articleDetail?nodeId=NODE07086678)</span>, Language Research, Vol.52, No.3, pp.511-532.


### Conference Presentations
* Sangah Lee (2022), <span style="color:#9AC6CD">Computational Linguistics and the Study of Korean Syntax</span>, The Society of Korean Linguistics.
* Sangah Lee and Hyopil Shin (2020), <span style="color:#9AC6CD">A Method of Infusing Additional Features into Pre-Trained BERT Models for Sentiment Analysis</span>, Korea Software Congress 2020.
* Sangah Lee and Suzi Park (2018), <span style="color:#9AC6CD">The Occurrence and Evolution of Feminist Twitterians</span>, Proceedings of The Discourse and Cognitive Linguistics Society of Korea.
